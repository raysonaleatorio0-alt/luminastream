...
export default async function MoviesPage({ searchParams }: PageProps) {
  ...
  const data = await getPopular('movie', currentPage);
  const movies: Media[] = data.results || [];
    ...
    <div className="min-h-screen">
      ...
      <main className="pt-32 px-6 md:px-12 pb-24 max-w-7xl mx-auto space-y-12">
        <div className="space-y-4">
          ...
          <p className="text-xl text-muted-foreground">Explore todos os filmes disponíveis no TMDB.</p>
        </div>
